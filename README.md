...
- **OLTP vs. OLAP**: I realized that while ORMs are great for app state, dbt is built for the scale and analytical complexity of a Data Warehouse.
...
2. **Data Testing**: Add `dbt test` blocks to verify my assumptions about Primary Keys automatically.
3. **Documentation**: Generate and host a `dbt docs` site to visualize the lineage graph.
